              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="slider-content">
                  ...
                  <div
                    ...
                    data-wow-delay=".2s"
                  >
                    <h2 class="title1">The best hotel</h2>
                  </div>
                  <!-- layer 2 -->
                  <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                    <h1 class="title2">WELCOME TO IT HOTEL</h1>
                  </div>
                  <!-- layer 3 -->
                  <div
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="wellcome-text">
                <div class="well-text text-center">
                  <h2>WELCOME TO IT KMITL HOTEL</h2>
          ...
          <div class="team-top">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
              <div class="single-team-member">
                <div class="team-img">
                  <a href="#">
                    <img src="img/team/rayrai.jpg" alt />
                  </a>
                  <div class="team-social-icon text-center">
                    <ul>
                      <li>
                        <a href="https://web.facebook.com/lalitwadee.singsud?_rdc=1&_rdr">
                          <i class="fa fa-facebook"></i>
                        </a>
                      </li>
                      <li>
                ...
                <div class="testimonial-carousel">
                  <div class="single-testi">
                    <div class="testi-text">
                      <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed pulvinar luctus est eget congue.
                        <br />consectetur adipiscing elit. Sed pulvinar luctus est eget congue.
                      </p>
                      <h6>Boby</h6>
                    </div>
                  </div>
